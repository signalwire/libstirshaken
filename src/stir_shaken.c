...
static const char* stir_shaken_get_error_string(stir_shaken_context_t *ss)
{
	...
	if (stir_shaken_is_error_set(ss)) {
		...
		if (!stir_shaken_zstr(ss->e.err_buf9)) {
			snprintf(ss->e.err, sizeof(ss->e.err), "Error stack (top to bottom, outermost first - deepest last):\n[ERR 0] %s\n[ERR 1] %s\n[ERR 2] %s\n[ERR 3] %s\n[ERR 4] %s\n[ERR 5] %s\n[ERR 6] %s\n[ERR 7] %s\n[ERR 8] %s\n[ERR 9] %s\n", ss->e.err_buf0, ss->e.err_buf1, ss->e.err_buf2, ss->e.err_buf3, ss->e.err_buf4, ss->e.err_buf5, ss->e.err_buf6, ss->e.err_buf7, ss->e.err_buf8, ss->e.err_buf9);
		} else if (!stir_shaken_zstr(ss->e.err_buf8)) {
			snprintf(ss->e.err, sizeof(ss->e.err), "Error stack (top to bottom, outermost first - deepest last):\n[ERR 0] %s\n[ERR 1] %s\n[ERR 2] %s\n[ERR 3] %s\n[ERR 4] %s\n[ERR 5] %s\n[ERR 6] %s\n[ERR 7] %s\n[ERR 8] %s\n", ss->e.err_buf0, ss->e.err_buf1, ss->e.err_buf2, ss->e.err_buf3, ss->e.err_buf4, ss->e.err_buf5, ss->e.err_buf6, ss->e.err_buf7, ss->e.err_buf8);
		} else if (!stir_shaken_zstr(ss->e.err_buf7)) {
			snprintf(ss->e.err, sizeof(ss->e.err), "Error stack (top to bottom, outermost first - deepest last):\n[ERR 0] %s\n[ERR 1] %s\n[ERR 2] %s\n[ERR 3] %s\n[ERR 4] %s\n[ERR 5] %s\n[ERR 6] %s\n[ERR 7] %s\n", ss->e.err_buf0, ss->e.err_buf1, ss->e.err_buf2, ss->e.err_buf3, ss->e.err_buf4, ss->e.err_buf5, ss->e.err_buf6, ss->e.err_buf7);
		} else if (!stir_shaken_zstr(ss->e.err_buf6)) {
			snprintf(ss->e.err, sizeof(ss->e.err), "Error stack (top to bottom, outermost first - deepest last):\n[ERR 0] %s\n[ERR 1] %s\n[ERR 2] %s\n[ERR 3] %s\n[ERR 4] %s\n[ERR 5] %s\n[ERR 6] %s\n", ss->e.err_buf0, ss->e.err_buf1, ss->e.err_buf2, ss->e.err_buf3, ss->e.err_buf4, ss->e.err_buf5, ss->e.err_buf6);
